...
# CScott, 2021-Mar-15, Extended functionallity to load and save inventory
#------------------------------------------#
...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        try:
            ...
            with open(file_name_track, 'w') as trackfile:
                for disc in lst_Inventory:
                    tracks = disc.cd_tracks
                    disc_id = disc.cd_id
                    for track in tracks:
                        record = '{},{}'.format(disc_id, track.get_record())
                        trackfile.write(record)
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            with open(file_name_track, 'r') as trackfile:
            ...
            with open(file_name_CD, 'w') as objFile:
               print('ERROR:'+ e.__doc__ +' An empty file called ' + file_name_CD + ' was created within the working directory')
            with open(file_name_track, 'w') as objFile:
               print('ERROR:'+ e.__doc__ +' An empty file called ' + file_name_track + ' was created within the working directory')
#        except Exception as e:
#            print('There was a general error!', e, e.__doc__, type(e), sep='\n')
